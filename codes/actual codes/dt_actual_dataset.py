...
Original file is located at
    https://colab.research.google.com/drive/1SwD86SuE4E6y5ywm7Q70KEhkC6MtrTnE
...
classification_models=["Decision Tree (DT)"]

#creating diff clasf algos for testing accuracy,computing time, precision, recall, ROC, PR
cls_mod=[]

cls_mod.insert(0,DecisionTreeClassifier(labelCol="label", featuresCol="features",seed=42))
...
paramGrid.insert(0,ParamGridBuilder() \
             ...
             .addGrid(cls_mod[0].impurity, ["gini", "entropy"]) \
             .addGrid(cls_mod[0].minInstancesPerNode, [1, 5, 10]) \
             .build())
