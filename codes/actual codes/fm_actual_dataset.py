...
Original file is located at
    https://colab.research.google.com/drive/1YoIFTGNm1LgmHcoeqkWSL4wQch26ETan
...
classification_models=["Factorization Machine (FM)"]

#creating diff clasf algos for testing accuracy,computing time, precision, recall, ROC, PR
cls_mod=[]


cls_mod.insert(0,FMClassifier(labelCol='label', featuresCol='features', seed=42))
...
.addGrid(cls_mod[0].regParam, [0.01, 0.1]) \
.addGrid(cls_mod[0].stepSize, [0.1,1])\
.addGrid(cls_mod[0].factorSize, [2,4])\
.build())
